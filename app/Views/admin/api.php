    ...
    <div class="card-body p-0">
        <ul class="nav nav-tabs px-3 pt-3" id="apiTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="tab-clients-tab" data-bs-toggle="tab" data-bs-target="#tab-clients" type="button" role="tab">
                    <i class="bi bi-key me-1"></i>Klien API
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-akad-tab" data-bs-toggle="tab" data-bs-target="#tab-akad" type="button" role="tab">
                    <i class="bi bi-database me-1"></i>Database Akademik
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-docs-tab" data-bs-toggle="tab" data-bs-target="#tab-docs" type="button" role="tab">
                    <i class="bi bi-file-text me-1"></i>Panduan
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-logs-tab" data-bs-toggle="tab" data-bs-target="#tab-logs" type="button" role="tab">
                    <i class="bi bi-clock-history me-1"></i>Log & Pelanggaran
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-dict-tab" data-bs-toggle="tab" data-bs-target="#tab-dict" type="button" role="tab">
                    <i class="bi bi-book me-1"></i>Kamus Data
                </button>
            </li>
        </ul>
        ...
        <div class="tab-content p-4">
                        ...
                        <?php foreach ($clients as $c): ?>
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#keys<?= (int) $c['id'] ?>" title="Kelola key">
                                        <i class="bi bi-key"></i>
                                    </button>
                            ...
                            <tr class="table-light">
                                <td colspan="7" class="p-0">
                                    <div class="collapse" id="keys<?= (int) $c['id'] ?>">
            ...
            <!-- ==================== TAB: DATABASE AKADEMIK ==================== -->
            <div class="tab-pane fade" id="tab-akad" role="tabpanel">
            ...
            <div class="tab-pane fade" id="tab-logs" role="tabpanel">
                ...
                <h6 class="fw-bold"><i class="bi bi-exclamation-octagon me-2"></i>Pelanggaran Wewenang <small class="text-secondary fw-normal">&mdash; 60 menit terakhir, per klien</small></h6>
            ...
            <!-- ==================== TAB: KAMUS DATA ==================== -->
            <div class="tab-pane fade" id="tab-dict" role="tabpanel">
